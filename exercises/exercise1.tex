    ...
    \begin{exercise}[Adición de momentos angulares: acoplamiento entre momento angular orbital y de spin (valor total: 5 pt)]
        ...
        \begin{enumerate}[label=(\alph*)]
            ...
            \begin{solution}
                ...
                \begin{empheq}[box = \color{pinkwave}\fbox]{equation}
                    \begin{alignedat}{1}
                        \ket{\dfrac{3}{2}, \frac{3}{2}} &= \ket{1, \frac{1}{2}; 1, \frac{1}{2}},\\
                ...
                \begin{align*}
                    ...
                    \Acolorboxed{\ket{\frac{1}{2}, -\frac{1}{2}} &= -\sqrt{\frac{2}{3}}\ket{1, \frac{1}{2}; -1, \frac{1}{2}} + \frac{1}{\sqrt{3}}\ket{1, \frac{1}{2}; 0, -\frac{1}{2}}.}
                \end{align*}
