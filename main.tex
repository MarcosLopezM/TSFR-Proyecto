...
\begin{document}
    ...
    \begin{exercise}
      ...
      Se debe calcular la densidad de esos materiales \(\rho = \left[\unit[per-mode=fraction]{\gram\per\cm\cubed}\right]\) que se requieren para calcular el peso total de la Tierra.
    \end{exercise}
