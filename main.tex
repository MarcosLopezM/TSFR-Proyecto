...
\hypersetup{
    ...
    pdfsubject={Física Atómica y Materia Condensada},%
    pdfkeywords={Facultad de Ciencias, UNAM, Física Atómica y Materia Condensada, Adición de momentos angulares, Teoría de perturbaciones},%
    unicode = true%
}
...
%%%%%%%%%%%%%%%%%%Nuevos comandos%%%%%%%%%%%%%%%%%%
\newcommand*{\group}{8287}
\newcommand*{\classname}{Física Atómica y Materia Condensada}
\newcommand*{\homeworknumber}{Tarea 1}
\newcommand*{\name}{Marcos López Merino}
\DTMsavedate{duedate}{2023-09-12}
